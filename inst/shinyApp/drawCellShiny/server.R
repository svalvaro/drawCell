function(input, output) {
  ...
  observeEvent(input$cell_type, {
    ...
    if (input$cell_type == "Animal cell")
      subcellular_colours(list("SL0073" = "white"))
    if (input$cell_type == "Animal neuronal cell")
      subcellular_colours(list("SL0288" = "white"))
    if (input$cell_type == "Animal epithelial cell")
      subcellular_colours(list("SL0038" = "white"))
    if (input$cell_type == "Animal muscle cell")
      subcellular_colours(list("SL0315" = "white"))
    if (input$cell_type == "Animal photoreceptor cell")
      subcellular_colours(list("SL0458" = "white"))
    if (input$cell_type == "Animal spermatozoa cell")
      subcellular_colours(list("SL0199" = "white"))
    if (input$cell_type == "Animal egg cell")
      subcellular_colours(list("SL0540" = "white"))
  })
}
